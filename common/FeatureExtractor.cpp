...
cv::Mat FeatureExtractor::GetORBFeaturesFromImage(
    const cv::Mat& input_image)
{
    std::vector<cv::KeyPoint> input_image_orb_keypoints;
    cv::Mat input_image_orb_descriptors;
    orb_feature_->detectAndCompute( input_image, 
                                cv::noArray(), 
...
cv::Mat FeatureExtractor::GetFASTFeaturesFromImage(
    const cv::Mat& input_image)
{
    std::vector<cv::KeyPoint> input_image_fast_keypoints;
    cv::Mat input_image_fast_descriptors;
    fast_feature_->detectAndCompute( input_image, 
                                cv::noArray(), 
...
std::vector<cv::KeyPoint> FeatureExtractor::GetKeypointsInImage(const cv::Mat& input_image, 
...
cv::Mat FeatureExtractor::GetFeaturesFromImage(const cv::Mat& input_image, 
                                                const VisualFeatures feature_type)
{
    switch (feature_type)
    {
